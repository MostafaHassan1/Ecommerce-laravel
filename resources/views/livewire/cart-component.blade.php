                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure><img src=" {{asset('storage') .'/' . $item->model->image }} " alt="{{$item->name}}">
                            </figure>
                        </div>
                        <div class="product-name">
                            <a class="link-to-product"
                                href="{{route('products.details',$item->model->slug)}}">{{$item->name}}</a>
                        </div>
                        ...
                        <div class="delete">
                            <a href="#" wire:click.pervent="removeItem({{$item->id}},'cart')" class="btn btn-delete"
                                title="">
